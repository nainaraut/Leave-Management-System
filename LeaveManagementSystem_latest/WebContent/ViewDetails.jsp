	...
	<tr>
		...
		<table width="70%" align="center">
			...
			<tr>
				...
				<td><input type="text" name="id" value="<%=ab.getName()%>"
					maxlength="6" /></td>
				<td width="30%"></td>
			</tr>
			<tr>
				<td width="35%">Employee Id</td>
				<td><input type="text" name="id" value="<%=ab.getId()%>"
					maxlength="6" /></td>
				<td width="30%"></td>
			</tr>
			<tr>
				<td width="35%">Designation</td>
				<td><input type="text" name="id" value="<%=ab.getDept()%>"
					maxlength="6" /></td>
				<td width="30%"></td>
			</tr>
			<tr>
				<td width="35%">Leave Type</td>
				<td><input type="text" name="id" value="<%=ab.getType()%>"
					maxlength="6" /></td>
				<td width="30%"></td>
			</tr>
			<tr>
				<td width="35%">Days Allocated</td>
				<td><input type="text" name="id" value="<%=ab.getDays()%>"
					maxlength="6" /></td>
				<td width="30%"></td>
			</tr>
			<%} %>
