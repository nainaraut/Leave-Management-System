...
<script type="text/javascript" src="resourse/js/calendar.js" language="JavaScript">
	...
	<body background="resource/image/wrapper-bg.jpg">
			...
			<center>
				<div id="header" style="color:#592C0C;">
					<h1 style="margin-bottom:0;"><center>Individual Leave Status Details</center></h1>
				</div>
 ...
 <a href="login.jsp">Logout</a>
	...
	<input type=hidden name=xcode value=indreaddone>
	
	<tr>
			<% 	}	%>
	<td colspan="3" align="center"><input type="submit" name="Done" value="OK">  </td></tr>
